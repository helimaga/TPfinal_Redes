...
vjdatadir = path + '/data_aux/imgt-reference/'
...
precalcdatafile = path + '/data_aux/tcrb_dist/'
...
vprecalc = pd.read_table(precalcdatafile + 'tcrbv_jun2016_dist.csv')
...
jprecalc = pd.read_table(precalcdatafile + 'tcrbj_jun2016_dist.csv')
